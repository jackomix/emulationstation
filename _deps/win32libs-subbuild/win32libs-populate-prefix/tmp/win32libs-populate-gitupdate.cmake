...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "origin/master"
  WORKING_DIRECTORY "D:/myEmulationStation/amber-es/.worktrees/lahee-integration/win32-libs"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/myEmulationStation/amber-es/.worktrees/lahee-integration/win32-libs'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/myEmulationStation/amber-es/.worktrees/lahee-integration/win32-libs'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
